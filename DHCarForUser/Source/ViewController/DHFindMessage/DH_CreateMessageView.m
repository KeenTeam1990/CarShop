...
@interface DH_CreateMessageView ()
AS_BOOL(isRefreshing);
AS_BOOL(isLoadingMore);
@end

@implementation DH_CreateMessageView

DEF_FACTORY_FRAME(DH_CreateMessageView);
DEF_MODEL(block);
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        __weak DH_CreateMessageView* tempself = self;
