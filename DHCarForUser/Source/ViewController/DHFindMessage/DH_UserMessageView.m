...
@interface DH_UserMessageView ()
AS_BOOL(isRefreshing);
AS_BOOL(isLoadingMore);
@end

@implementation DH_UserMessageView

DEF_FACTORY_FRAME(DH_UserMessageView);
DEF_MODEL(block);
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        __weak DH_UserMessageView* tempself = self;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.messageReadLabel.text = [NSString stringWithFormat:@"易车网   阅读:  %@",[titleData hasItemAndBack:@"readcount"]];
...
-(NSString *)changeTime:(NSString *)timeValue
{
    ...
    [fromtter setDateFormat:@"YYYY:MM:dd hh:mm"];
